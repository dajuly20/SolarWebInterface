...
<table class="rwd-table">
  ...
  <tr>
	...
	<td data-th="Ladung an diesem Tag">	 <b><?php   /*if($chgLast != 0){ echo round($chgLast-$row["charge"],2); }else{ echo " --- ";} */ echo $row["chgDiff"];     ?></b>A/h 	</td>
	<!--<td data-th="Ladung in dieser Stunde">	<b><?php echo $row["chargedThisDay"];     ?>A/h<b></td>-->
  </tr>
  <?php
 $chgLast = $row["charge"];
  } ?>
